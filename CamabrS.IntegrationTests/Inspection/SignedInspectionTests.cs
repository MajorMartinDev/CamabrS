...
public sealed class SignedInspectionTests(AppFixture fixture) : ApiWithSignedInspection(fixture)
{
    //assign
    ...
    [Fact]
    public async Task Unassigning_lock_holding_Specialist_from_a_signed_Inspection_should_fail()
    {
        false.ShouldBeTrue();
    ...
    [Fact]
    public async Task Closeing_Inspection_by_lock_holding_Specialist_should_succeed()
    {
        false.ShouldBeTrue();
    ...
    [Fact]
    public async Task Closeing_Inspection_by_another_Specialist_should_fail()
    {
        false.ShouldBeTrue();
