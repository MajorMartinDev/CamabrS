...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public class POST_api_inspections_submit : Wolverine.Http.HttpHandler
    {
        ...
        public POST_api_inspections_submit(Wolverine.Http.WolverineHttpOptions wolverineHttpOptions, Wolverine.Marten.Publishing.OutboxedSessionFactory outboxedSessionFactory, FluentValidation.IValidator<CamabrS.API.Inspection.Submitting.SubmitInspectionResult> validator, Wolverine.Http.FluentValidation.IProblemDetailSource<CamabrS.API.Inspection.Submitting.SubmitInspectionResult> problemDetailSource, Wolverine.Runtime.IWolverineRuntime wolverineRuntime) : base(wolverineHttpOptions)
        {
