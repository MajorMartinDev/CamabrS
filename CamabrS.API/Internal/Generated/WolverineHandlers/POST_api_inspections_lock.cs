...
{
    // START: POST_api_inspections_lock
    public class POST_api_inspections_lock : Wolverine.Http.HttpHandler
    {
        ...
        public POST_api_inspections_lock(Wolverine.Http.WolverineHttpOptions wolverineHttpOptions, Wolverine.Runtime.IWolverineRuntime wolverineRuntime, Wolverine.Http.FluentValidation.IProblemDetailSource<CamabrS.API.Inspection.Locking.LockInspection> problemDetailSource, Wolverine.Marten.Publishing.OutboxedSessionFactory outboxedSessionFactory, FluentValidation.IValidator<CamabrS.API.Inspection.Locking.LockInspection> validator) : base(wolverineHttpOptions)
        {
        ...
        public override async System.Threading.Tasks.Task Handle(Microsoft.AspNetCore.Http.HttpContext httpContext)
        {
            ...
            var (command, jsonContinue) = await ReadJsonAsync<CamabrS.API.Inspection.Locking.LockInspection>(httpContext);
            if (jsonContinue == Wolverine.HandlerContinuation.Stop) return;
            
            // Execute FluentValidation validators
            var result1 = await Wolverine.Http.FluentValidation.Internals.FluentValidationHttpExecutor.ExecuteOne<CamabrS.API.Inspection.Locking.LockInspection>(_validator, _problemDetailSource, command).ConfigureAwait(false);
            ...
            (var apiResponse_response, var events, var outgoingMessages) = CamabrS.API.Inspection.Locking.LockEndpoints.Post(command, eventStream.Aggregate, user);
