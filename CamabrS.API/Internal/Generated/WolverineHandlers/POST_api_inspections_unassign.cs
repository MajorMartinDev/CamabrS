...
{
    // START: POST_api_inspections_unassign
    public class POST_api_inspections_unassign : Wolverine.Http.HttpHandler
    {
        ...
        public POST_api_inspections_unassign(Wolverine.Http.WolverineHttpOptions wolverineHttpOptions, Wolverine.Runtime.IWolverineRuntime wolverineRuntime, Wolverine.Http.FluentValidation.IProblemDetailSource<CamabrS.API.Inspection.Assigning.UnassignSpecialist> problemDetailSource, Wolverine.Marten.Publishing.OutboxedSessionFactory outboxedSessionFactory, FluentValidation.IValidator<CamabrS.API.Inspection.Assigning.UnassignSpecialist> validator) : base(wolverineHttpOptions)
        {
        ...
        public override async System.Threading.Tasks.Task Handle(Microsoft.AspNetCore.Http.HttpContext httpContext)
        {
            ...
            var (command, jsonContinue) = await ReadJsonAsync<CamabrS.API.Inspection.Assigning.UnassignSpecialist>(httpContext);
            if (jsonContinue == Wolverine.HandlerContinuation.Stop) return;
            
            // Execute FluentValidation validators
            var result1 = await Wolverine.Http.FluentValidation.Internals.FluentValidationHttpExecutor.ExecuteOne<CamabrS.API.Inspection.Assigning.UnassignSpecialist>(_validator, _problemDetailSource, command).ConfigureAwait(false);
            ...
            (var result, var events, var outgoingMessages) = CamabrS.API.Inspection.Assigning.UnassignEndpoints.Post(command, eventStream.Aggregate, now, user);
    ...
    // END: POST_api_inspections_unassign
