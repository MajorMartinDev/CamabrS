...
{
    // START: POST_api_inspections_sign
    public class POST_api_inspections_sign : Wolverine.Http.HttpHandler
    {
        ...
        public POST_api_inspections_sign(Wolverine.Http.WolverineHttpOptions wolverineHttpOptions, FluentValidation.IValidator<CamabrS.API.Inspection.Signing.SignInspection> validator, Wolverine.Marten.Publishing.OutboxedSessionFactory outboxedSessionFactory, Wolverine.Http.FluentValidation.IProblemDetailSource<CamabrS.API.Inspection.Signing.SignInspection> problemDetailSource, Wolverine.Runtime.IWolverineRuntime wolverineRuntime) : base(wolverineHttpOptions)
        {
        ...
        public override async System.Threading.Tasks.Task Handle(Microsoft.AspNetCore.Http.HttpContext httpContext)
        {
            ...
            var (command, jsonContinue) = await ReadJsonAsync<CamabrS.API.Inspection.Signing.SignInspection>(httpContext);
            if (jsonContinue == Wolverine.HandlerContinuation.Stop) return;
            
            // Execute FluentValidation validators
            var result1 = await Wolverine.Http.FluentValidation.Internals.FluentValidationHttpExecutor.ExecuteOne<CamabrS.API.Inspection.Signing.SignInspection>(_validator, _problemDetailSource, command).ConfigureAwait(false);
            ...
            (var apiResponse_response, var events, var outgoingMessages) = CamabrS.API.Inspection.Signing.SignEndpoints.Post(command, eventStream.Aggregate, user);
